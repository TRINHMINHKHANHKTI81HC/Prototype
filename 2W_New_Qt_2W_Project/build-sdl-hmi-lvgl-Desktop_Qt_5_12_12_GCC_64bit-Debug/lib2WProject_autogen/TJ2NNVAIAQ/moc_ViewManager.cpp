...
#include "../../../sdl-hmi-lvgl/gui/includes/ViewManager.h"
...
QT_MOC_LITERAL(1, 12, 16), // "viewStateChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 9), // "viewState"
QT_MOC_LITERAL(4, 40, 22), // "requestChangeViewState"
QT_MOC_LITERAL(5, 63, 4), // "from"
QT_MOC_LITERAL(6, 68, 2) // "to"

    },
    "ViewManager\0viewStateChanged\0\0viewState\0"
    "requestChangeViewState\0from\0to"
};
...
void ViewManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->viewStateChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->requestChangeViewState((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ViewManager::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ViewManager::viewStateChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->getViewState(); break;
        default: break;
        }
...
// SIGNAL 0
void ViewManager::viewStateChanged(QString _t1)
{
